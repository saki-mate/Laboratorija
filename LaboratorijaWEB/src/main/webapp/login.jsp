...
<br><br>
	...
	<div class="login">
		...
		<form action="${loginUrl}" method="post" class="regForma">

			<input type="text" name="username" placeholder="Broj licne karte"
				required><br> <input type="password" name="password"
				placeholder="Unesite šifru" required><br> <input
				type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
			<br> <input type="submit" value="Uloguj se"><br> <br>
		</form>
	</div>
