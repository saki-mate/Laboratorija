...
<table class = "centar">
    ...
    <c:forEach items="${odabraneAnalize}" var="a">
        <tr>
            <td>${a.naziv}</td>
            <td>${a.cena}</td>
...
<br><br>
Ukupna cena za odabrane analize: ${suma};

<br><br>
<table class = "centar">
    <tr>
        <th id = "tabela">Laborant</th>
        <th id = "tabela">Vreme</th>
        <th id = "tabela">Odabir</th>
    </tr>
    <c:forEach items="${slobodniTermini}" var="t">
        <tr>
            <td>${t.laboratorijaKorisnik.ime} ${t.laboratorijaKorisnik.prezime }</td>
            <td>${t.vreme}</td>
            <td><a href = "/Laboratorija/klijentController/rezervacija?idTermin=${t.idTermin}">Rezervisi</a></td>
        </tr>
    </c:forEach>
</table>
<br><br>
<form action ="/Laboratorija/klijentController/slobodniTermini" >
	<input type = "submit" value = "Izlistaj sve slobodne termine">
</form>
