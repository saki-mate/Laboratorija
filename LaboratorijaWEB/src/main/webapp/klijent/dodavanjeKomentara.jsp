...
<br><br>
<form action = "/Laboratorija/klijentController/sveRezervacije">
	<input type = "submit" value = "izlistajSve">
</form>
<br><br>
Odaberite rezervaciju kojoj odgovara navedeni komentar:
<br><br>
<table class = "centar">
    <tr>
        <th id = "tabela">Naziv analize</th>
        <th id = "tabela">Vreme</th>
        <th id = "tabela">Laborant</th>
    </tr>
    <c:forEach items="${listaRezervacija}" var="r">
        <tr>
            <td>${r.analiza.naziv}</td>
            <td>${r.datum}</td>
            <td>${r.idLaborant}</td>
            <td><a href = "/Laboratorija/klijentController/dodavanjeKomentara?idRegistracija=${r.idRezervacija}">Dodaj komentar</a></td>
        </tr>
    </c:forEach>
</table>
