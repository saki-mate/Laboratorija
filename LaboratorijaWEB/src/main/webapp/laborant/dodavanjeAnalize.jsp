...
<br><br>
<div class = "prviBlok">
		<h1>Dodavanje nove <span>analize</span></h1>
	</div>
	<form action="/Laboratorija/laborantController/dodajAnalizu" method="POST">

		<input type="text" name="naziv" placeholder="naziv"><br>
		<input type="number" name="cena" placeholder="cena"><br><br>
		<select name="cbKategorija">
			<c:forEach var="i" items="${kategorije}">
				<option value="${i.idKategorija}">${i.naziv}</option>
			</c:forEach>
		</select><br><br> <input type="submit" value="Sacuvaj">
	</form>
