...
<br><br>
		<div>
			<h1>Svi <span>komentari</span></h1>
		</div>
<br><br>
<table class = "centar">
    <tr>
        <th id = "tabela">Komentar</th>
        <th id = "tabela">Vreme</th>
        <th id = "tabela">Laborant</th>
        <th id = "tabela">Klijent</th>
        
    </tr>
    <c:forEach items="${sviKomentari}" var="kom">
        <tr>
            <td>${kom.opis}</td>
            <td>${kom.vreme}</td>
            <td>${kom.rezervacija.idLaborant}</td>
            <td>${kom.rezervacija.laboratorijaKorisnik.ime} ${kom.rezervacija.laboratorijaKorisnik.prezime }</td>
