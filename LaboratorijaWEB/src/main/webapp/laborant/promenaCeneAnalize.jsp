...
<!-- ------------------------------------------------------------------------------------------------------------ -->
<br><br>
<form action ="/Laboratorija/laborantController/promeniCenu" method = "POST">
	<br>
	<select name = "cbAnalize">
		<c:forEach var="a" items = "${analize}">
			<option value = "${a.idAnaliza}">${a.naziv} ${a.cena}</option>
		</c:forEach>
	</select>
	<input type="number" name = "cenaNova" placeholder = "Nova cena: "><br><br>
	<input type="submit" value="promeni"><br>
